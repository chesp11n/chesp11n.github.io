...
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(v, h, p) {
...
$jscomp.polyfill = function(v, h, p, n) {
    if (h) {
        ...
        n = p[v];
        h = h(n);
        h != n && null != h && $jscomp.defineProperty(p, v, {
            configurable: !0,
            writable: !0,
            value: h
        })
...
;
$jscomp.polyfill("Object.setPrototypeOf", function(v) {
    return v ? v : "object" != typeof "".__proto__ ? null : function(h, p) {
        h.__proto__ = p;
        if (h.__proto__ !== p)
...
(function(v) {
    "object" === typeof exports && "undefined" !== typeof module ? module.exports = v() : "function" === typeof define && define.amd ? define([], v) : ("undefined" !== typeof window ? window : "undefined" !== typeof global ? global : "undefined" !== typeof self ? self : this).jsmediatags = v()
}
)(function() {
    return function h(p, n, m) {
        function q(c, b) {
            if (!n[c]) {
                ...
                p[c][0].call(b.exports, function(b) {
                    var k = p[c][1][b];
                    return q(k ? k : b)
                }, b, b.exports, h, p, n, m)
            }
        ...
        for (var t = "function" == typeof require && require, f = 0; f < m.length; f++)
            q(m[f]);
        return q
    }({
        1: [function(h, p, n) {}
        ...
        3: [function(h, p, n) {
            ...
            function f(b) {
                f = Object.setPrototypeOf ? Object.getPrototypeOf : function(a) {
            ...
            function g(b, a) {
                g = Object.setPrototypeOf || function(a, d) {
                    a.__proto__ = d;
                    return a
                }
                ;
        ...
        4: [function(h, p, n) {
            ...
            function g(a, e) {
                g = Object.setPrototypeOf || function(d, a) {
                    d.__proto__ = a;
                    return d
                }
                ;
                ...
                q(h, [{
                    ...
                    value: function(f, c) {
                        ...
                        if (-1 === g.startIx)
                            ...
                            var a = {
                                offset: Math.min(f, k.offset),
                                data: c
                            };
                            f > k.offset && (f = this._sliceData(k.data, 0, f - k.offset),
                            a.data = this._concatData(f, c));
                            b && (f = this._sliceData(a.data, 0, r.offset - a.offset),
                    ...
                    key: "_getChunkRange",
                    value: function(f, c) {
                        for (var b, g, k = -1, r = -1, a = 0, e = 0; e < this._fileData.length; e++,
                        a = e) {
                        ...
                        for (e = k; e < this._fileData.length && !(g = this._fileData[e].offset,
                        b = g + this._fileData[e].data.length,
                        c >= g - 1 && (r = e),
                        c <= b + 1); e++)
                            ;
            ...
            h = function(d) {
                ...
                t(l, [{
                    ...
                    value: function(a, d) {
                        ...
                        this._pictureOffset && (r = a.getLongAt(this._pictureOffset, !0),
        ...
        7: [function(h, p, n) {
            function m(b) {
                m = "function" === typeof Symbol && "symbol" === typeof Symbol.iterator ? function(b) {
                    return typeof b
                }
                : function(b) {
            ...
            function b(c, g) {
                b = Object.setPrototypeOf || function(a, e) {
                    a.__proto__ = e;
                    return a
                }
                ;
        ...
        8: [function(h, p, n) {
            ...
            function f(a, e, d, b) {
                ...
                a = d.getStringWithCharsetAt(a + 1 + l.bytesReadCount, e - 1 - l.bytesReadCount, b);
                return {
                    user_description: l.toString(),
                    data: a.toString()
                }
            }
            h("./MediaFileReader");
                ...
                q(a, null, [{
                    ...
                    value: function(e, d, b, c, g) {
                        for (var l = {}, k = this._getFrameHeaderSize(c); e < d - k; ) {
                            ...
                            if (!g || -1 !== g.indexOf(u)) {
                                if ("MP3e" === u || "\x00MP3" === u || "\x00\x00MP" === u || " MP3" === u)
                                    break;
                                h && h.format.unsynchronisation && !c.flags.unsynchronisation && (m = this.getUnsyncFileReader(m, r, w),
                                r = 0,
                                w = m.getSize());
                                h && h.format.data_length_indicator && (r += 4,
                                w -= 4);
                    ...
                    value: function(a, d, b) {
                        ...
                        if (c == String.fromCharCode(0, 0, 0) || c == String.fromCharCode(0, 0, 0, 0))
                            c = "";
        ...
        9: [function(h, p, n) {
            ...
            function b(c, a) {
                b = Object.setPrototypeOf || function(a, d) {
                    a.__proto__ = d;
                    return a
                }
                ;
            ...
            h = function(b) {
                ...
                t(a, [{
                    ...
                    value: function(a, b) {
                        ...
                        b = p + 10;
                        n.flags.unsynchronisation && (a = g.getUnsyncFileReader(a, e, p),
                        e = 0,
                        b = a.getSize());
                        a = g.readFrames(e, b, a, n, d);
                        for (var q in k)
                            k.hasOwnProperty(q) && (d = this._getFrameData(a, k[q])) && (n.tags[q] = d);
                        for (var t in a)
                            a.hasOwnProperty(t) && (n.tags[t] = a[t]);
                        return n
                    }
                }, {
                    key: "_getFrameData",
                    value: function(a, b) {
                        for (var d = 0, e; e = b[d]; d++)
                            if (e in a)
                                return a = a[e]instanceof Array ? a[e][0] : a[e],
                                a.data
                    }
                }, {
                    key: "getShortcuts",
        ...
        10: [function(h, p, n) {
            ...
            function b(a, e) {
                b = Object.setPrototypeOf || function(a, b) {
                    a.__proto__ = b;
                    return a
                }
                ;
            ...
            h = function(a) {
                ...
                t(b, [{
                        ...
                        if (b >= a.getSize())
                            ...
                            if (0 == l || isNaN(l))
                                ...
                                if (this._isContainerAtom(g)) {
                                    "meta" == g && (b += 4);
                                    var k = (e ? e + "." : "") + g;
                                    "moov.udta.meta.ilst" === k ? a.loadRange([b, b + l], c) : a.loadRange([b + 8, b + 8 + 8], {
                                        onSuccess: function() {
                    ...
                    value: function(a, b) {
                        ...
                        for (var e in r)
                            r.hasOwnProperty(e) && (b = d[r[e]]) && (d[e] = "track" === e ? b.data.track : b.data);
                        return {
                            type: "MP4",
                    ...
                    value: function(a, b) {
                        ...
                        if ("trkn" == e)
                            ...
                            case "int":
                            case "uint":
                                l = ("int" == c ? 1 == f ? a.getSByteAt : 2 == f ? a.getSShortAt : 4 == f ? a.getSLongAt : a.getLongAt : 1 == f ? a.getByteAt : 2 == f ? a.getShortAt : a.getLongAt).call(a, b + (8 == f ? 4 : 0), !0);
                                break;
                            case "jpeg":
                            case "png":
                                l = {
        ...
        11: [function(h, p, n) {
            ...
            function t(c, b, g) {
                b in c ? Object.defineProperty(c, b, {
                    value: g,
                    enumerable: !0,
                    configurable: !0,
                    writable: !0
            ...
            h = function() {
                ...
                q(f, [{
                    ...
                    value: function(c) {
                        if (!c)
                            return null;
                        for (var b = [], g = this.getShortcuts(), f = 0, h; h = c[f]; f++)
                            b = b.concat(g[h] || [h]);
                        return b
                    }
                }], [{
                ...
                readUTF16String: function(c, b, g) {
                    ...
                    for (var e = 0; k < g; e++) {
                        ...
                        if (0 == l)
                            ...
                            216 > d || 224 <= d ? b[e] = String.fromCharCode(l) : (d = (c[k + h] << 8) + c[k + a],
                            k += 2,
        ...
        14: [function(h, p, n) {
            ...
            function g(a, b) {
                g = Object.setPrototypeOf || function(a, b) {
                    a.__proto__ = b;
                    return a
                }
                ;
            ...
            n = function(a) {
                ...
                t(e, [{
                    ...
                    value: function(a) {
                        ...
                        this._makeXHRRequest("HEAD", null, {
                            onSuccess: function(d) {
                                (d = b._parseContentLength(d)) ? (b._size = d,
                                a.onSuccess()) : b._fetchSizeWithGetRequest(a)
                            },
                            onError: a.onError
                        })
                    }
                    ...
                    value: function(a, b) {
                        var d = this;
                        d._fileData.hasDataRange(a[0], Math.min(d._size, a[1])) ? setTimeout(b.onSuccess, 1) : (a = this._roundRangeToChunkMultiple(a),
                    ...
                    value: function(a, b, c) {
                        ...
                        "undefined" !== typeof d.onload ? (d.onload = f,
                        d.onerror = function() {
                            if (c.onError)
                                c.onError({
                                    type: "xhr",
                        ...
                        ;
                        e._config.timeoutInSec && (d.timeout = 1E3 * e._config.timeoutInSec,
                        d.ontimeout = function() {
                            if (c.onError)
                                c.onError({
                                    type: "xhr",
                                    info: "Timeout after " + d.timeout / 1E3 + "s. Use jsmediatags.Config.setXhrTimeout to override.",
                                    xhr: d
                                })
                        }
                        );
        ...
        15: [function(h, p, n) {
            ...
            "undefined" === typeof process || process.browser || (h = "undefined" !== typeof navigator && "ReactNative" === navigator.product ? h("./ReactNativeFileReader") : h("./NodeFileReader"),
            n.addFileReader(h));
            p.exports = {
                read: function(a, b) {
                    (new w(a)).read(b)
